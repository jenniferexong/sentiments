      ...
      >
        <div className="relative">
          ...
          <input
            ...
            autoComplete="off"
            className="flex h-16 w-full items-center rounded border border-white/50 bg-transparent px-4 font-ubunto-mono text-xl tracking-[0.25em] outline-none sm:w-[400px] sm:text-2xl"
          />
